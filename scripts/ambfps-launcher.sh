...
# Check AMBXST_FPS_LIB first, then fall back to AMBXST_FPS_LIB
...
# libambfps.so checks both AMBXST_FPS, AMBXST_FPS and ambxst-fps env vars.
AMBXST_FPS=1
AMBXST_FPS=1
LD_PRELOAD="$AMBFPS_LIB${LD_PRELOAD:+:$LD_PRELOAD}"
export AMBXST_FPS AMBXST_FPS LD_PRELOAD
